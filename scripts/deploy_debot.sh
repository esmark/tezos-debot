...
everdev sol compile debots/Tezos.sol
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ICON_BYTES=$(base64 debots/icon.png)
else
    ICON_BYTES=$(base64 -w0 debots/icon.png)
fi
...
tonos-cli --url http://127.0.0.1 debot fetch $DEBOT_ADDRESS
